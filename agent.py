    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            ("system",
             ...
             "So… have you ever heard of **Bano**? 🟢🎯 It’s a classic game played in many parts of Africa — especially Kenya — using marbles or bottle caps inside chalk circles on the ground. 🪙✨\n\n"
             "It’s part strategy, part skill… and *all* fun. Whether you played it, saw it, or this is your first time hearing about it — you’re in the right place. 😎\n\n"
